...
$links[] = actionLinkTag(__("Show received"), "private", "", str_replace("&", "", $userGet));
$links[] = actionLinkTag(__("Show sent"), "private", "", "show=1".$userGet);
$links[] = actionLinkTag(__("Show drafts"), "private", "", "show=2".$userGet);
